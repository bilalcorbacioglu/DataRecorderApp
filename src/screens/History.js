...
import { Text, View, AsyncStorage, Switch, StyleSheet, ScrollView, FlatList, Dimensions } from 'react-native';
...
class History extends React.Component {
  ...
  componentDidMount() {
    FileSystem.readDirectoryAsync(FileSystem.documentDirectory).then(files=>{
      this.setState({files: files.filter(file => file.match(".csv") != null ).reverse()});
   })
  }
