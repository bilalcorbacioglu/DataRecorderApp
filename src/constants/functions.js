...
const convertStringCSV = array => {
  var csvstring = '';
  var csvstringColumn =
    'Timestamp,Latitude,Longitude,Altitude,Accuracy,Speed,Accelerometer X, Accelerometer Y, Accelerometer Z';
  ...
  array.forEach(item => {
    csvstring =
      ...
      ',' +
      item.coords.altitude +
      ',' +
      item.coords.accuracy +
      ',' +
      item.coords.speed +
      ',' +
      item.accelerometerData.x +
      ',' +
      item.accelerometerData.y +
      ',' +
